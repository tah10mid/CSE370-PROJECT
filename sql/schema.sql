-- =====================================================================
-- Thesis Finder - Database Schema (3NF)
-- CSE370 Project
-- =====================================================================
...
-- =====================================================================
-- 1. USER  (super-entity for Student / Teacher ISA)
-- =====================================================================
CREATE TABLE user (
...
-- =====================================================================
-- 4. MULTIVALUED attributes for TEACHER
-- =====================================================================
...
-- =====================================================================
-- 5. MULTIVALUED attributes for USER
-- =====================================================================
...
-- =====================================================================
-- 7. STUDENT_JOIN_PROJECT  (which students joined which work)
-- =====================================================================
CREATE TABLE student_join_project (
    project_id INT NOT NULL,
    id         INT NOT NULL,          -- student user_id
...
-- =====================================================================
-- 8. PROJECT_STATUS  (multivalued, lifecycle history)
-- =====================================================================
CREATE TABLE project_status (
    project_id      INT NOT NULL,
    project_status  VARCHAR(40) NOT NULL,   -- open, in_progress, completed, closed
...
-- =====================================================================
-- 10. TEAM_REQUEST_STATUS  (multivalued status)
-- =====================================================================
CREATE TABLE team_request_status (
    request_id          INT NOT NULL,
    team_request_status VARCHAR(40) NOT NULL,   -- pending, accepted, rejected
...
-- =====================================================================
-- 12. SENDS / RECIEVES  (link message <-> user / request)
-- =====================================================================
